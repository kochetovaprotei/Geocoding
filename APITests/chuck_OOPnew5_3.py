...
class TestNewJoke:
    ...
    def create_new_joke_from_category(self):
        ...
        print(check_info)
        assert check_info == ["sport"]  # проверяем значение ключа categories
...
joke_sport = TestNewJoke()
joke_sport.create_new_joke_from_category()
